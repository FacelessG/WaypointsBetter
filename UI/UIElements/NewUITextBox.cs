...
namespace waypoints.Tiles.UIElements
{
	internal class NewUITextBox : UIPanel//UITextPanel<string>
	{
		...
		public NewUITextBox(string hintText, string text = "")
		{
			...
			Texture2D texture = ModContent.GetTexture("waypoints/UI/Icons/clearButton");
			var closeButton = new UIHoverImageButton(texture, "Clear");
